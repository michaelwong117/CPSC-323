...
typedef struct proc {
    ...
    pid_t p_gpid;                  // process group
    uintptr_t program_break;       // process's program breakpoint
    uintptr_t original_break;      // process's program breakpoint
...
// palloc(pid)
// Region based memory allocator that utilizes page based virtual-to-physical memory 
// translation to allocate memory pages.
