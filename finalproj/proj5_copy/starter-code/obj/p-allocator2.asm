...
static inline pid_t sys_getpid(void) {
  ...
  14000f:	e8 82 02 00 00       	call   140296 <srand>
...
static inline void sys_yield(void) {
  ...
  14003e:	e8 19 02 00 00       	call   14025c <rand>
...
void printer_vprintf(printer* p, int color, const char* format, va_list val) {
  ...
  1402d0:	e9 a4 04 00 00       	jmp    140779 <printer_vprintf+0x4d2>
  ...
  1402f8:	e8 37 ff ff ff       	call   140234 <strchr>
  ...
  140353:	ff 24 c5 c0 0a 14 00 	jmp    *0x140ac0(,%rax,8)
  ...
  1403b9:	e9 6f ff ff ff       	jmp    14032d <printer_vprintf+0x86>
            width = va_arg(val, int);
  ...
  1403d6:	e9 52 ff ff ff       	jmp    14032d <printer_vprintf+0x86>
        int width = -1;
  1403db:	41 bd ff ff ff ff    	mov    $0xffffffff,%r13d
  1403e1:	e9 47 ff ff ff       	jmp    14032d <printer_vprintf+0x86>
            ++format;
  ...
  140404:	e9 34 ff ff ff       	jmp    14033d <printer_vprintf+0x96>
  ...
  140456:	e9 e2 fe ff ff       	jmp    14033d <printer_vprintf+0x96>
                precision = va_arg(val, int);
  ...
  140472:	e9 f3 00 00 00       	jmp    14056a <printer_vprintf+0x2c3>
            ++format;
  140477:	48 83 c3 01          	add    $0x1,%rbx
            length = 1;
  14047b:	b9 01 00 00 00       	mov    $0x1,%ecx
            goto again;
  140480:	e9 bd fe ff ff       	jmp    140342 <printer_vprintf+0x9b>
  ...
  1404c1:	41 bc b8 0a 14 00    	mov    $0x140ab8,%r12d
            break;
  1404c7:	e9 35 01 00 00       	jmp    140601 <printer_vprintf+0x35a>
            long x = length ? va_arg(val, long) : va_arg(val, int);
  ...
  140560:	e9 e2 02 00 00       	jmp    140847 <printer_vprintf+0x5a0>
            base = 16;
  ...
  1405a0:	e9 a2 02 00 00       	jmp    140847 <printer_vprintf+0x5a0>
  ...
  140664:	e8 63 fb ff ff       	call   1401cc <strnlen>
  ...
  140686:	e8 26 fb ff ff       	call   1401b1 <strlen>
  ...
  1407a2:	e9 51 fe ff ff       	jmp    1405f8 <printer_vprintf+0x351>
  ...
  1407f7:	41 b8 00 00 00 00    	mov    $0x0,%r8d
            break;
  1407fd:	e9 ff fd ff ff       	jmp    140601 <printer_vprintf+0x35a>
            numbuf[0] = va_arg(val, int);
  ...
  140832:	e9 ca fd ff ff       	jmp    140601 <printer_vprintf+0x35a>
        if (flags & FLAG_NUMERIC) {
  ...
  140877:	e9 9a fd ff ff       	jmp    140616 <printer_vprintf+0x36f>
                prefix = "-";
  ...
  1408b3:	e9 87 fd ff ff       	jmp    14063f <printer_vprintf+0x398>
                   && (base == 16 || base == -16)
  ...
  1408ef:	e9 4b fd ff ff       	jmp    14063f <printer_vprintf+0x398>
            len = strlen(data);
  1408f4:	4c 89 e7             	mov    %r12,%rdi
  1408f7:	e8 b5 f8 ff ff       	call   1401b1 <strlen>
  ...
  140927:	e9 56 fd ff ff       	jmp    140682 <printer_vprintf+0x3db>
                   && len + (int) strlen(prefix) < width) {
  14092c:	48 8b 7d a0          	mov    -0x60(%rbp),%rdi
  140930:	e8 7c f8 ff ff       	call   1401b1 <strlen>
  ...
  140950:	e9 2d fd ff ff       	jmp    140682 <printer_vprintf+0x3db>
            numbuf[0] = (*format ? *format : '%');
  ...
  140966:	e9 96 fc ff ff       	jmp    140601 <printer_vprintf+0x35a>
        int flags = 0;
  14096b:	c7 45 a8 00 00 00 00 	movl   $0x0,-0x58(%rbp)
  140972:	e9 b0 f9 ff ff       	jmp    140327 <printer_vprintf+0x80>
}
...
int console_vprintf(int cpos, int color, const char* format, va_list val) {
  ...
  1409b7:	e8 eb f8 ff ff       	call   1402a7 <printer_vprintf>
...
int console_printf(int cpos, int color, const char* format, ...) {
  ...
  1409fa:	e8 87 ff ff ff       	call   140986 <console_vprintf>
}
  1409ff:	c9                   	leave  
  140a00:	c3                   	ret    
...
int vsnprintf(char* s, size_t size, const char* format, va_list val) {
  ...
  140a3b:	e8 67 f8 ff ff       	call   1402a7 <printer_vprintf>
        *sp.s = 0;
...
int snprintf(char* s, size_t size, const char* format, ...) {
  ...
  140a78:	e8 84 ff ff ff       	call   140a01 <vsnprintf>
    va_end(val);
    return n;
}
  140a7d:	c9                   	leave  
