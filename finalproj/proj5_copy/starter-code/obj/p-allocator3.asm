...
static inline pid_t sys_getpid(void) {
  ...
  18000f:	e8 82 02 00 00       	call   180296 <srand>
...
static inline void sys_yield(void) {
  ...
  18003e:	e8 19 02 00 00       	call   18025c <rand>
...
void printer_vprintf(printer* p, int color, const char* format, va_list val) {
  ...
  1802d0:	e9 a4 04 00 00       	jmp    180779 <printer_vprintf+0x4d2>
  ...
  1802f8:	e8 37 ff ff ff       	call   180234 <strchr>
  ...
  180353:	ff 24 c5 c0 0a 18 00 	jmp    *0x180ac0(,%rax,8)
  ...
  1803b9:	e9 6f ff ff ff       	jmp    18032d <printer_vprintf+0x86>
            width = va_arg(val, int);
  ...
  1803d6:	e9 52 ff ff ff       	jmp    18032d <printer_vprintf+0x86>
        int width = -1;
  1803db:	41 bd ff ff ff ff    	mov    $0xffffffff,%r13d
  1803e1:	e9 47 ff ff ff       	jmp    18032d <printer_vprintf+0x86>
            ++format;
  ...
  180404:	e9 34 ff ff ff       	jmp    18033d <printer_vprintf+0x96>
  ...
  180456:	e9 e2 fe ff ff       	jmp    18033d <printer_vprintf+0x96>
                precision = va_arg(val, int);
  ...
  180472:	e9 f3 00 00 00       	jmp    18056a <printer_vprintf+0x2c3>
            ++format;
  180477:	48 83 c3 01          	add    $0x1,%rbx
            length = 1;
  18047b:	b9 01 00 00 00       	mov    $0x1,%ecx
            goto again;
  180480:	e9 bd fe ff ff       	jmp    180342 <printer_vprintf+0x9b>
  ...
  1804c1:	41 bc b8 0a 18 00    	mov    $0x180ab8,%r12d
            break;
  1804c7:	e9 35 01 00 00       	jmp    180601 <printer_vprintf+0x35a>
            long x = length ? va_arg(val, long) : va_arg(val, int);
  ...
  180560:	e9 e2 02 00 00       	jmp    180847 <printer_vprintf+0x5a0>
            base = 16;
  ...
  1805a0:	e9 a2 02 00 00       	jmp    180847 <printer_vprintf+0x5a0>
  ...
  180664:	e8 63 fb ff ff       	call   1801cc <strnlen>
  ...
  180686:	e8 26 fb ff ff       	call   1801b1 <strlen>
  ...
  1807a2:	e9 51 fe ff ff       	jmp    1805f8 <printer_vprintf+0x351>
  ...
  1807f7:	41 b8 00 00 00 00    	mov    $0x0,%r8d
            break;
  1807fd:	e9 ff fd ff ff       	jmp    180601 <printer_vprintf+0x35a>
            numbuf[0] = va_arg(val, int);
  ...
  180832:	e9 ca fd ff ff       	jmp    180601 <printer_vprintf+0x35a>
        if (flags & FLAG_NUMERIC) {
  ...
  180877:	e9 9a fd ff ff       	jmp    180616 <printer_vprintf+0x36f>
                prefix = "-";
  ...
  1808b3:	e9 87 fd ff ff       	jmp    18063f <printer_vprintf+0x398>
                   && (base == 16 || base == -16)
  ...
  1808ef:	e9 4b fd ff ff       	jmp    18063f <printer_vprintf+0x398>
            len = strlen(data);
  1808f4:	4c 89 e7             	mov    %r12,%rdi
  1808f7:	e8 b5 f8 ff ff       	call   1801b1 <strlen>
  ...
  180927:	e9 56 fd ff ff       	jmp    180682 <printer_vprintf+0x3db>
                   && len + (int) strlen(prefix) < width) {
  18092c:	48 8b 7d a0          	mov    -0x60(%rbp),%rdi
  180930:	e8 7c f8 ff ff       	call   1801b1 <strlen>
  ...
  180950:	e9 2d fd ff ff       	jmp    180682 <printer_vprintf+0x3db>
            numbuf[0] = (*format ? *format : '%');
  ...
  180966:	e9 96 fc ff ff       	jmp    180601 <printer_vprintf+0x35a>
        int flags = 0;
  18096b:	c7 45 a8 00 00 00 00 	movl   $0x0,-0x58(%rbp)
  180972:	e9 b0 f9 ff ff       	jmp    180327 <printer_vprintf+0x80>
}
...
int console_vprintf(int cpos, int color, const char* format, va_list val) {
  ...
  1809b7:	e8 eb f8 ff ff       	call   1802a7 <printer_vprintf>
...
int console_printf(int cpos, int color, const char* format, ...) {
  ...
  1809fa:	e8 87 ff ff ff       	call   180986 <console_vprintf>
}
  1809ff:	c9                   	leave  
  180a00:	c3                   	ret    
...
int vsnprintf(char* s, size_t size, const char* format, va_list val) {
  ...
  180a3b:	e8 67 f8 ff ff       	call   1802a7 <printer_vprintf>
        *sp.s = 0;
...
int snprintf(char* s, size_t size, const char* format, ...) {
  ...
  180a78:	e8 84 ff ff ff       	call   180a01 <vsnprintf>
    va_end(val);
    return n;
}
  180a7d:	c9                   	leave  
