...
static inline void sys_yield(void) {
  ...
  10000b:	e8 fc 02 00 00       	call   10030c <rand>
...
static inline pid_t sys_fork(void) {
  ...
  100036:	89 c3                	mov    %eax,%ebx
    ...
    pid_t p = sys_getpid();
    srand(p);
  100038:	e8 09 03 00 00       	call   100346 <srand>
...
static inline uintptr_t read_rsp(void) {
  ...
  10007e:	e8 89 02 00 00       	call   10030c <rand>
  ...
  1000f7:	e8 7f 09 00 00       	call   100a7b <console_printf>
...
static inline void sys_exit(void) {
 ...
 spinloop: goto spinloop;       // should never get here
  ...
  100115:	e8 f2 01 00 00       	call   10030c <rand>
...
void printer_vprintf(printer* p, int color, const char* format, va_list val) {
  ...
  100380:	e9 a4 04 00 00       	jmp    100829 <printer_vprintf+0x4d2>
  ...
  1003a8:	e8 37 ff ff ff       	call   1002e4 <strchr>
  ...
  100403:	ff 24 c5 70 0b 10 00 	jmp    *0x100b70(,%rax,8)
  ...
  100469:	e9 6f ff ff ff       	jmp    1003dd <printer_vprintf+0x86>
            width = va_arg(val, int);
  ...
  100486:	e9 52 ff ff ff       	jmp    1003dd <printer_vprintf+0x86>
        int width = -1;
  10048b:	41 bd ff ff ff ff    	mov    $0xffffffff,%r13d
  100491:	e9 47 ff ff ff       	jmp    1003dd <printer_vprintf+0x86>
            ++format;
  ...
  1004b4:	e9 34 ff ff ff       	jmp    1003ed <printer_vprintf+0x96>
  ...
  100506:	e9 e2 fe ff ff       	jmp    1003ed <printer_vprintf+0x96>
                precision = va_arg(val, int);
  ...
  100522:	e9 f3 00 00 00       	jmp    10061a <printer_vprintf+0x2c3>
            ++format;
  100527:	48 83 c3 01          	add    $0x1,%rbx
            length = 1;
  10052b:	b9 01 00 00 00       	mov    $0x1,%ecx
            goto again;
  100530:	e9 bd fe ff ff       	jmp    1003f2 <printer_vprintf+0x9b>
  ...
  100571:	41 bc 61 0b 10 00    	mov    $0x100b61,%r12d
            break;
  100577:	e9 35 01 00 00       	jmp    1006b1 <printer_vprintf+0x35a>
            long x = length ? va_arg(val, long) : va_arg(val, int);
  ...
  100610:	e9 e2 02 00 00       	jmp    1008f7 <printer_vprintf+0x5a0>
            base = 16;
  ...
  100650:	e9 a2 02 00 00       	jmp    1008f7 <printer_vprintf+0x5a0>
  ...
  100714:	e8 63 fb ff ff       	call   10027c <strnlen>
  ...
  100736:	e8 26 fb ff ff       	call   100261 <strlen>
  ...
  100852:	e9 51 fe ff ff       	jmp    1006a8 <printer_vprintf+0x351>
  ...
  1008a7:	41 b8 00 00 00 00    	mov    $0x0,%r8d
            break;
  1008ad:	e9 ff fd ff ff       	jmp    1006b1 <printer_vprintf+0x35a>
            numbuf[0] = va_arg(val, int);
  ...
  1008e2:	e9 ca fd ff ff       	jmp    1006b1 <printer_vprintf+0x35a>
        if (flags & FLAG_NUMERIC) {
  ...
  100927:	e9 9a fd ff ff       	jmp    1006c6 <printer_vprintf+0x36f>
                prefix = "-";
  ...
  100963:	e9 87 fd ff ff       	jmp    1006ef <printer_vprintf+0x398>
                   && (base == 16 || base == -16)
  ...
  10099f:	e9 4b fd ff ff       	jmp    1006ef <printer_vprintf+0x398>
            len = strlen(data);
  1009a4:	4c 89 e7             	mov    %r12,%rdi
  1009a7:	e8 b5 f8 ff ff       	call   100261 <strlen>
  ...
  1009d7:	e9 56 fd ff ff       	jmp    100732 <printer_vprintf+0x3db>
                   && len + (int) strlen(prefix) < width) {
  1009dc:	48 8b 7d a0          	mov    -0x60(%rbp),%rdi
  1009e0:	e8 7c f8 ff ff       	call   100261 <strlen>
  ...
  100a00:	e9 2d fd ff ff       	jmp    100732 <printer_vprintf+0x3db>
            numbuf[0] = (*format ? *format : '%');
  ...
  100a16:	e9 96 fc ff ff       	jmp    1006b1 <printer_vprintf+0x35a>
        int flags = 0;
  100a1b:	c7 45 a8 00 00 00 00 	movl   $0x0,-0x58(%rbp)
  100a22:	e9 b0 f9 ff ff       	jmp    1003d7 <printer_vprintf+0x80>
}
...
int console_vprintf(int cpos, int color, const char* format, va_list val) {
  ...
  100a67:	e8 eb f8 ff ff       	call   100357 <printer_vprintf>
...
int console_printf(int cpos, int color, const char* format, ...) {
  ...
  100aaa:	e8 87 ff ff ff       	call   100a36 <console_vprintf>
}
  100aaf:	c9                   	leave  
  100ab0:	c3                   	ret    
...
int vsnprintf(char* s, size_t size, const char* format, va_list val) {
  ...
  100aeb:	e8 67 f8 ff ff       	call   100357 <printer_vprintf>
        *sp.s = 0;
...
int snprintf(char* s, size_t size, const char* format, ...) {
  ...
  100b28:	e8 84 ff ff ff       	call   100ab1 <vsnprintf>
    va_end(val);
    return n;
}
  100b2d:	c9                   	leave  
