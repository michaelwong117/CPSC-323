...
static inline pid_t sys_fork(void) {
  ...
  100032:	e8 e4 02 00 00       	call   10031b <srand>
...
void printer_vprintf(printer* p, int color, const char* format, va_list val) {
  ...
  100355:	e9 a4 04 00 00       	jmp    1007fe <printer_vprintf+0x4d2>
  ...
  10037d:	e8 37 ff ff ff       	call   1002b9 <strchr>
  ...
  1003d8:	ff 24 c5 20 0d 10 00 	jmp    *0x100d20(,%rax,8)
  ...
  10043e:	e9 6f ff ff ff       	jmp    1003b2 <printer_vprintf+0x86>
            width = va_arg(val, int);
  ...
  10045b:	e9 52 ff ff ff       	jmp    1003b2 <printer_vprintf+0x86>
        int width = -1;
  100460:	41 bd ff ff ff ff    	mov    $0xffffffff,%r13d
  100466:	e9 47 ff ff ff       	jmp    1003b2 <printer_vprintf+0x86>
            ++format;
  ...
  100489:	e9 34 ff ff ff       	jmp    1003c2 <printer_vprintf+0x96>
  ...
  1004db:	e9 e2 fe ff ff       	jmp    1003c2 <printer_vprintf+0x96>
                precision = va_arg(val, int);
  ...
  1004f7:	e9 f3 00 00 00       	jmp    1005ef <printer_vprintf+0x2c3>
            ++format;
  1004fc:	48 83 c3 01          	add    $0x1,%rbx
            length = 1;
  100500:	b9 01 00 00 00       	mov    $0x1,%ecx
            goto again;
  100505:	e9 bd fe ff ff       	jmp    1003c7 <printer_vprintf+0x9b>
  ...
  100546:	41 bc 20 0f 10 00    	mov    $0x100f20,%r12d
            break;
  10054c:	e9 35 01 00 00       	jmp    100686 <printer_vprintf+0x35a>
            long x = length ? va_arg(val, long) : va_arg(val, int);
  ...
  1005e5:	e9 e2 02 00 00       	jmp    1008cc <printer_vprintf+0x5a0>
            base = 16;
  ...
  100625:	e9 a2 02 00 00       	jmp    1008cc <printer_vprintf+0x5a0>
  ...
  1006e9:	e8 63 fb ff ff       	call   100251 <strnlen>
  ...
  10070b:	e8 26 fb ff ff       	call   100236 <strlen>
  ...
  100827:	e9 51 fe ff ff       	jmp    10067d <printer_vprintf+0x351>
  ...
  10087c:	41 b8 00 00 00 00    	mov    $0x0,%r8d
            break;
  100882:	e9 ff fd ff ff       	jmp    100686 <printer_vprintf+0x35a>
            numbuf[0] = va_arg(val, int);
  ...
  1008b7:	e9 ca fd ff ff       	jmp    100686 <printer_vprintf+0x35a>
        if (flags & FLAG_NUMERIC) {
  ...
  1008fc:	e9 9a fd ff ff       	jmp    10069b <printer_vprintf+0x36f>
                prefix = "-";
  ...
  100938:	e9 87 fd ff ff       	jmp    1006c4 <printer_vprintf+0x398>
                   && (base == 16 || base == -16)
  ...
  100974:	e9 4b fd ff ff       	jmp    1006c4 <printer_vprintf+0x398>
            len = strlen(data);
  100979:	4c 89 e7             	mov    %r12,%rdi
  10097c:	e8 b5 f8 ff ff       	call   100236 <strlen>
  ...
  1009ac:	e9 56 fd ff ff       	jmp    100707 <printer_vprintf+0x3db>
                   && len + (int) strlen(prefix) < width) {
  1009b1:	48 8b 7d a0          	mov    -0x60(%rbp),%rdi
  1009b5:	e8 7c f8 ff ff       	call   100236 <strlen>
  ...
  1009d5:	e9 2d fd ff ff       	jmp    100707 <printer_vprintf+0x3db>
            numbuf[0] = (*format ? *format : '%');
  ...
  1009eb:	e9 96 fc ff ff       	jmp    100686 <printer_vprintf+0x35a>
        int flags = 0;
  1009f0:	c7 45 a8 00 00 00 00 	movl   $0x0,-0x58(%rbp)
  1009f7:	e9 b0 f9 ff ff       	jmp    1003ac <printer_vprintf+0x80>
}
...
int console_vprintf(int cpos, int color, const char* format, va_list val) {
  ...
  100a3c:	e8 eb f8 ff ff       	call   10032c <printer_vprintf>
...
int console_printf(int cpos, int color, const char* format, ...) {
  ...
  100a7f:	e8 87 ff ff ff       	call   100a0b <console_vprintf>
}
  100a84:	c9                   	leave  
  100a85:	c3                   	ret    
...
int vsnprintf(char* s, size_t size, const char* format, va_list val) {
  ...
  100ac0:	e8 67 f8 ff ff       	call   10032c <printer_vprintf>
        *sp.s = 0;
...
int snprintf(char* s, size_t size, const char* format, ...) {
  ...
  100afd:	e8 84 ff ff ff       	call   100a86 <vsnprintf>
    va_end(val);
    return n;
}
  100b02:	c9                   	leave  
...
void app_printf(int colorid, const char* format, ...) {
  ...
  100b9d:	e8 69 fe ff ff       	call   100a0b <console_vprintf>
    va_end(val);
...
void panic(const char* format, ...) {
  ...
  100c02:	e8 ab f5 ff ff       	call   1001b2 <memcpy>
  ...
  100c1a:	e8 67 fe ff ff       	call   100a86 <vsnprintf>
  ...
  100c50:	e8 fb fd ff ff       	call   100a50 <console_printf>
}
...
static inline pid_t __attribute__((noreturn)) sys_panic(const char* msg) {
 ...
 loop: goto loop;
  ...
  100c7d:	e8 f2 f5 ff ff       	call   100274 <strcpy>
...
void assert_fail(const char* file, int line, const char* msg) {
  ...
  100ca5:	e8 a6 fd ff ff       	call   100a50 <console_printf>
    asm volatile ("int %0" : /* no result */
