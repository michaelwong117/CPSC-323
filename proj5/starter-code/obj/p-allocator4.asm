...
static inline pid_t sys_getpid(void) {
  ...
  1c000f:	e8 82 02 00 00       	call   1c0296 <srand>
...
static inline void sys_yield(void) {
  ...
  1c003e:	e8 19 02 00 00       	call   1c025c <rand>
...
void printer_vprintf(printer* p, int color, const char* format, va_list val) {
  ...
  1c02d0:	e9 a4 04 00 00       	jmp    1c0779 <printer_vprintf+0x4d2>
  ...
  1c02f8:	e8 37 ff ff ff       	call   1c0234 <strchr>
  ...
  1c0353:	ff 24 c5 c0 0a 1c 00 	jmp    *0x1c0ac0(,%rax,8)
  ...
  1c03b9:	e9 6f ff ff ff       	jmp    1c032d <printer_vprintf+0x86>
            width = va_arg(val, int);
  ...
  1c03d6:	e9 52 ff ff ff       	jmp    1c032d <printer_vprintf+0x86>
        int width = -1;
  1c03db:	41 bd ff ff ff ff    	mov    $0xffffffff,%r13d
  1c03e1:	e9 47 ff ff ff       	jmp    1c032d <printer_vprintf+0x86>
            ++format;
  ...
  1c0404:	e9 34 ff ff ff       	jmp    1c033d <printer_vprintf+0x96>
  ...
  1c0456:	e9 e2 fe ff ff       	jmp    1c033d <printer_vprintf+0x96>
                precision = va_arg(val, int);
  ...
  1c0472:	e9 f3 00 00 00       	jmp    1c056a <printer_vprintf+0x2c3>
            ++format;
  1c0477:	48 83 c3 01          	add    $0x1,%rbx
            length = 1;
  1c047b:	b9 01 00 00 00       	mov    $0x1,%ecx
            goto again;
  1c0480:	e9 bd fe ff ff       	jmp    1c0342 <printer_vprintf+0x9b>
  ...
  1c04c1:	41 bc b8 0a 1c 00    	mov    $0x1c0ab8,%r12d
            break;
  1c04c7:	e9 35 01 00 00       	jmp    1c0601 <printer_vprintf+0x35a>
            long x = length ? va_arg(val, long) : va_arg(val, int);
  ...
  1c0560:	e9 e2 02 00 00       	jmp    1c0847 <printer_vprintf+0x5a0>
            base = 16;
  ...
  1c05a0:	e9 a2 02 00 00       	jmp    1c0847 <printer_vprintf+0x5a0>
  ...
  1c0664:	e8 63 fb ff ff       	call   1c01cc <strnlen>
  ...
  1c0686:	e8 26 fb ff ff       	call   1c01b1 <strlen>
  ...
  1c07a2:	e9 51 fe ff ff       	jmp    1c05f8 <printer_vprintf+0x351>
  ...
  1c07f7:	41 b8 00 00 00 00    	mov    $0x0,%r8d
            break;
  1c07fd:	e9 ff fd ff ff       	jmp    1c0601 <printer_vprintf+0x35a>
            numbuf[0] = va_arg(val, int);
  ...
  1c0832:	e9 ca fd ff ff       	jmp    1c0601 <printer_vprintf+0x35a>
        if (flags & FLAG_NUMERIC) {
  ...
  1c0877:	e9 9a fd ff ff       	jmp    1c0616 <printer_vprintf+0x36f>
                prefix = "-";
  ...
  1c08b3:	e9 87 fd ff ff       	jmp    1c063f <printer_vprintf+0x398>
                   && (base == 16 || base == -16)
  ...
  1c08ef:	e9 4b fd ff ff       	jmp    1c063f <printer_vprintf+0x398>
            len = strlen(data);
  1c08f4:	4c 89 e7             	mov    %r12,%rdi
  1c08f7:	e8 b5 f8 ff ff       	call   1c01b1 <strlen>
  ...
  1c0927:	e9 56 fd ff ff       	jmp    1c0682 <printer_vprintf+0x3db>
                   && len + (int) strlen(prefix) < width) {
  1c092c:	48 8b 7d a0          	mov    -0x60(%rbp),%rdi
  1c0930:	e8 7c f8 ff ff       	call   1c01b1 <strlen>
  ...
  1c0950:	e9 2d fd ff ff       	jmp    1c0682 <printer_vprintf+0x3db>
            numbuf[0] = (*format ? *format : '%');
  ...
  1c0966:	e9 96 fc ff ff       	jmp    1c0601 <printer_vprintf+0x35a>
        int flags = 0;
  1c096b:	c7 45 a8 00 00 00 00 	movl   $0x0,-0x58(%rbp)
  1c0972:	e9 b0 f9 ff ff       	jmp    1c0327 <printer_vprintf+0x80>
}
...
int console_vprintf(int cpos, int color, const char* format, va_list val) {
  ...
  1c09b7:	e8 eb f8 ff ff       	call   1c02a7 <printer_vprintf>
...
int console_printf(int cpos, int color, const char* format, ...) {
  ...
  1c09fa:	e8 87 ff ff ff       	call   1c0986 <console_vprintf>
}
  1c09ff:	c9                   	leave  
  1c0a00:	c3                   	ret    
...
int vsnprintf(char* s, size_t size, const char* format, va_list val) {
  ...
  1c0a3b:	e8 67 f8 ff ff       	call   1c02a7 <printer_vprintf>
        *sp.s = 0;
...
int snprintf(char* s, size_t size, const char* format, ...) {
  ...
  1c0a78:	e8 84 ff ff ff       	call   1c0a01 <vsnprintf>
    va_end(val);
    return n;
}
  1c0a7d:	c9                   	leave  
