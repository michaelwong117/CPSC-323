...
static inline pid_t sys_getpid(void) {
  ...
  10000f:	e8 82 02 00 00       	call   100296 <srand>
...
static inline void sys_yield(void) {
  ...
  10003e:	e8 19 02 00 00       	call   10025c <rand>
...
void printer_vprintf(printer* p, int color, const char* format, va_list val) {
  ...
  1002d0:	e9 a4 04 00 00       	jmp    100779 <printer_vprintf+0x4d2>
  ...
  1002f8:	e8 37 ff ff ff       	call   100234 <strchr>
  ...
  100353:	ff 24 c5 c0 0a 10 00 	jmp    *0x100ac0(,%rax,8)
  ...
  1003b9:	e9 6f ff ff ff       	jmp    10032d <printer_vprintf+0x86>
            width = va_arg(val, int);
  ...
  1003d6:	e9 52 ff ff ff       	jmp    10032d <printer_vprintf+0x86>
        int width = -1;
  1003db:	41 bd ff ff ff ff    	mov    $0xffffffff,%r13d
  1003e1:	e9 47 ff ff ff       	jmp    10032d <printer_vprintf+0x86>
            ++format;
  ...
  100404:	e9 34 ff ff ff       	jmp    10033d <printer_vprintf+0x96>
  ...
  100456:	e9 e2 fe ff ff       	jmp    10033d <printer_vprintf+0x96>
                precision = va_arg(val, int);
  ...
  100472:	e9 f3 00 00 00       	jmp    10056a <printer_vprintf+0x2c3>
            ++format;
  100477:	48 83 c3 01          	add    $0x1,%rbx
            length = 1;
  10047b:	b9 01 00 00 00       	mov    $0x1,%ecx
            goto again;
  100480:	e9 bd fe ff ff       	jmp    100342 <printer_vprintf+0x9b>
  ...
  1004c1:	41 bc b8 0a 10 00    	mov    $0x100ab8,%r12d
            break;
  1004c7:	e9 35 01 00 00       	jmp    100601 <printer_vprintf+0x35a>
            long x = length ? va_arg(val, long) : va_arg(val, int);
  ...
  100560:	e9 e2 02 00 00       	jmp    100847 <printer_vprintf+0x5a0>
            base = 16;
  ...
  1005a0:	e9 a2 02 00 00       	jmp    100847 <printer_vprintf+0x5a0>
  ...
  100664:	e8 63 fb ff ff       	call   1001cc <strnlen>
  ...
  100686:	e8 26 fb ff ff       	call   1001b1 <strlen>
  ...
  1007a2:	e9 51 fe ff ff       	jmp    1005f8 <printer_vprintf+0x351>
  ...
  1007f7:	41 b8 00 00 00 00    	mov    $0x0,%r8d
            break;
  1007fd:	e9 ff fd ff ff       	jmp    100601 <printer_vprintf+0x35a>
            numbuf[0] = va_arg(val, int);
  ...
  100832:	e9 ca fd ff ff       	jmp    100601 <printer_vprintf+0x35a>
        if (flags & FLAG_NUMERIC) {
  ...
  100877:	e9 9a fd ff ff       	jmp    100616 <printer_vprintf+0x36f>
                prefix = "-";
  ...
  1008b3:	e9 87 fd ff ff       	jmp    10063f <printer_vprintf+0x398>
                   && (base == 16 || base == -16)
  ...
  1008ef:	e9 4b fd ff ff       	jmp    10063f <printer_vprintf+0x398>
            len = strlen(data);
  1008f4:	4c 89 e7             	mov    %r12,%rdi
  1008f7:	e8 b5 f8 ff ff       	call   1001b1 <strlen>
  ...
  100927:	e9 56 fd ff ff       	jmp    100682 <printer_vprintf+0x3db>
                   && len + (int) strlen(prefix) < width) {
  10092c:	48 8b 7d a0          	mov    -0x60(%rbp),%rdi
  100930:	e8 7c f8 ff ff       	call   1001b1 <strlen>
  ...
  100950:	e9 2d fd ff ff       	jmp    100682 <printer_vprintf+0x3db>
            numbuf[0] = (*format ? *format : '%');
  ...
  100966:	e9 96 fc ff ff       	jmp    100601 <printer_vprintf+0x35a>
        int flags = 0;
  10096b:	c7 45 a8 00 00 00 00 	movl   $0x0,-0x58(%rbp)
  100972:	e9 b0 f9 ff ff       	jmp    100327 <printer_vprintf+0x80>
}
...
int console_vprintf(int cpos, int color, const char* format, va_list val) {
  ...
  1009b7:	e8 eb f8 ff ff       	call   1002a7 <printer_vprintf>
...
int console_printf(int cpos, int color, const char* format, ...) {
  ...
  1009fa:	e8 87 ff ff ff       	call   100986 <console_vprintf>
}
  1009ff:	c9                   	leave  
  100a00:	c3                   	ret    
...
int vsnprintf(char* s, size_t size, const char* format, va_list val) {
  ...
  100a3b:	e8 67 f8 ff ff       	call   1002a7 <printer_vprintf>
        *sp.s = 0;
...
int snprintf(char* s, size_t size, const char* format, ...) {
  ...
  100a78:	e8 84 ff ff ff       	call   100a01 <vsnprintf>
    va_end(val);
    return n;
}
  100a7d:	c9                   	leave  
